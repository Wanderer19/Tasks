...
namespace Visualizer
{
    public partial class BubbleSortVisualizer : Visualizer
    {
        ...
        public readonly Point[] FirstPointerCoordinates = new Point[] { new Point(23, 80), new Point(70, 55), new Point(123, 80) };
        ...
        {
            graphics.DrawString(SymbolComparison, digitsFont, digitsBrush, 50 + VisualizationArray.WidthElemet * index, 20, formatDrawing);
        }
    }
}
